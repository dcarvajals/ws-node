    ...
    switch (obj.status) {
        case 2:
            successTo({
                ...
                nameApplication: (obj.tittle === undefined) ? "App - Taxi" : obj.tittle
            });
            break;
        case 3:
            warningTo({
...
function cargando() {
    let containerLoading = document.createElement('div');
    containerLoading.innerHTML = "<strong> Cargando... </strong> <br> <img src='img/loading.gif' width='80' style='margin-top: 1rem'>";
    swal.fire({
        width: 400,
